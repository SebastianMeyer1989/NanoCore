#!/usr/bin/perl
#
# run: perl extractPileUpFrequencies.pl --samtools_bin /path/to/samtools --BAM /path/to/BAM --outputFile /path/to/outputFile --referenceGenome /path/to/refGenome.fa
# --minBaseQuality needs modification? value 5-8?
#T = +
#t = -
#
...
$samtools_command .= " -r $regionName" if($regionName);
